...
import "./SIS.css"
const MapStudenttoStaff = () => {
  return (
    <>
     <div className="SDheading"><span>SIS </span><label> / Enrollement / Map Student TO Staff </label> </div>
    <div className='std-prf-top3'>
    <h3 className='std-prof-h3'>Map Student TO Staff</h3>      
       </div>
       <div  className="SDashboard">
        <p className='mapStudent-p' ><span className='mapspan'>Note :</span> The students who are mapped to staff here are shown in the staff login while calling the parents using Call to Parents feature on Smart School App.</p>
       
        <div className='std-prf-ca'>
    <div className='bank-details'>
            <p className='label-1'>Class Section:</p>
            <select className='std-map-select'>
        ...
        <div>
            <p className='std-map-select1-p label-1' >All Staff :</p>
            <select  className='std-map-select1'>
            <option>-All-</option>
...
export default MapStudenttoStaff;