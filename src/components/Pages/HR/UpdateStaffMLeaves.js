...
const UpdateStaffMLeaves = () => {
  return (
    <>
         <div className="SDheading"><span>HR </span><label> / Staff Leaves / Update Staff Monthly Leaves</label> </div>
...
export default UpdateStaffMLeaves;