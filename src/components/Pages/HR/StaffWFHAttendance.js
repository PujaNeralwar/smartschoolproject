...
const StaffWFHAttendance = () => {
  ...
  return (
    <>
        <div className="SDheading"><span>HR </span><label> / Staff Attendance / Staff Work From Home Attendance </label> </div>

<div  className="SDashboard">
 <div className='top2'>
    <label>Staff Work from Home Attendance </label>
...
export default StaffWFHAttendance;